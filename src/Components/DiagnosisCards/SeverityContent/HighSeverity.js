...
const EnglishSeverityContent = () => {
  return (
    <React.Fragment>
      <p>
        You should consult with a medical professional immediately or call your local Covid 19
        Hotline. You should inquire about getting tested for Covid 19 or being admitted to a care
        facility for treatment. It’s hard being sick, but your actions can protect others.
      </p>
      <p>
        If you begin to experience constant chest pain, pressure, extreme difficulty breathing,
        extreme lightheadedness or disorientation, please call Emergency Services immediately (911).
      </p>
      <p>
...
export const HighSeverity = ({ language }: {| language: string |}) => {
