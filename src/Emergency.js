    ...
    return (
        <Dialog open={open} fullWidth={true} maxWidth={"md"} disableBackdropClick >
            ...
            <DialogActions className={classes.surveyActions}>
                <Button type="button" onClick={() => onButtonClick(true)} className={classes.submitButton} variant={"contained"} size={"large"}>YES</Button>
                <Button type="button" onClick={() => onButtonClick(false)} className={classes.submitButton} variant={"contained"} size={"large"}>NO</Button>
            </DialogActions>
        </Dialog>
    );
}