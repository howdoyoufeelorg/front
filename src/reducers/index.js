...
const diagnosisSeverityReducer = (state = initialState.diagnosisSeverity, action) => {
  switch (action.type) {
  ...
  switch (action.type) {
    ...
    case 'AJAX_ERROR':
      return Object.assign({}, state, {
        ajaxInProgress: false,
        ajaxFailed: true,
        ajaxError: action.errorMessage ? action.errorMessage : 'UNKNOWN ERROR',
      });
    case 'AJAX_END':
      return Object.assign({}, initialState.ajax);
    default:
...
export default combineReducers({
  ...
  diagnosisSeverity: diagnosisSeverityReducer,
});
